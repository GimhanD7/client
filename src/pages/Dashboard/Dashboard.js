        ...
        <div className='flex'>
            ...
            <ul>
                <li>
                            ...
                            <Link className={`text-gray-300 text-sm flex items-center gap-x-4 cursor-pointer p-2 hover:bg-light-white rounded-md  ${!open && "hidden"} `} to = "/myStudent"><BsFillPersonBadgeFill/>Student</Link>
                        
                </li> <br/> 
                <li>
                    
                            <Link className={`text-gray-300 text-sm flex items-center gap-x-4 cursor-pointer p-2 hover:bg-light-white rounded-md  ${!open && "hidden"} `} to = "/myTeacher"><BsFillPersonLinesFill/>Teacher</Link>
                        
                </li> <br/> 
                <li>
                    
                            <Link className={`text-gray-300 text-sm flex items-center gap-x-4 cursor-pointer p-2 hover:bg-light-white rounded-md  ${!open && "hidden"} `} to = "/courses"><BsFillWalletFill/>Courses</Link>
                        
                </li> <br/> 
                <li >
                    
                            <Link className={`text-gray-300 text-sm flex items-center gap-x-4 cursor-pointer p-2 hover:bg-light-white rounded-md mt-2 ${!open && "hidden"} `} to = "/transactions"><BsCashCoin/>Transactions</Link>
                        
                </li> <br/> 
                <li >
                    
                            <Link className={`text-gray-300 text-sm flex items-center gap-x-4 cursor-pointer p-2 hover:bg-light-white rounded-md mt-2 ${!open && "hidden"} `} to = "/listfeedback"><BsSearch/>Feedback</Link>
                        <ul >
                            <li className={`text-gray-300 text-sm flex items-center gap-x-4 cursor-pointer p-2 hover:bg-light-white rounded-md mt-2 ${!open && "hidden"} `} ><a href="/listFeedback" >Feedback List</a></li>
                        <li className={`text-gray-300 text-sm flex items-center gap-x-4 cursor-pointer p-2 hover:bg-light-white rounded-md mt-2 ${!open && "hidden"} `}><a  href="/adFeedback" >Response </a></li>
                        </ul>
                </li>
                <br/><br/> <br/> 
                <li >
                    
                            <Link className={`text-gray-300 text-sm flex items-center gap-x-4 cursor-pointer p-2 hover:bg-light-white rounded-md mt-2 ${!open && "hidden"} text-white text-lg block float-left cursor-pointer`} to = "/"><BsDiagram2 className={`text-white text-lg block float-left cursor-pointer 
                    ${open && "mr-2"}`}/>Logout</Link>
